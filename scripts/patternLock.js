...
mhnUI = {
    ...
    lock: function() {
        mhnUI.page.hide(), pattern = new PatternLock(".mhn-lock", {
            ...
            $(".mhn-lock-title").html('<span class="mhn-lock-failure">Буква S не получилась. Попробуйте еще раз.</span>'), $(".patt-holder").removeClass("patt-success"), setTimeout(function() {
                pattern.reset(), mhnUI.message()
            }, 2e3)
        })
    },
